/********************************************************************************
** Form generated from reading UI file 'audioplay.ui'
**
...
#ifndef UI_AUDIOPLAY_H
#define UI_AUDIOPLAY_H
...
public:
    ...
    void setupUi(QMainWindow *AudioPlay)
    {
        ...
        commandLinkButton->setMinimumSize(QSize(0, 30));
        commandLinkButton->setMaximumSize(QSize(70, 40));
        commandLinkButton->setLayoutDirection(Qt::LeftToRight);

        horizontalLayout_7->addWidget(commandLinkButton);
        ...
        pushButton_WindowMin->setObjectName(QStringLiteral("pushButton_WindowMin"));
        ...
        pushButton_WindowMax->setObjectName(QStringLiteral("pushButton_WindowMax"));
        ...
        pushButton_WindowExit->setObjectName(QStringLiteral("pushButton_WindowExit"));
        ...
        Slider_ProgressBar->setObjectName(QStringLiteral("Slider_ProgressBar"));
        Slider_ProgressBar->setStyleSheet(QLatin1String("QSlider::groove:horizontal {  \n"
...
""));
        ...
        label_MusicTime->setObjectName(QStringLiteral("label_MusicTime"));
        ...
        label_Volume_2->setObjectName(QStringLiteral("label_Volume_2"));
        ...
        label_Volume_2->setStyleSheet(QStringLiteral(""));
        ...
        Slider_Volume->setStyleSheet(QStringLiteral(""));
        ...
        label_Volume->setStyleSheet(QStringLiteral(""));
        ...
        PushButton_Previous->setStyleSheet(QStringLiteral(""));
        ...
        PushButton_PlayStop->setObjectName(QStringLiteral("PushButton_PlayStop"));
        ...
        PushButton_PlayStop->setStyleSheet(QStringLiteral(""));
        ...
        PushButton_Next->setStyleSheet(QStringLiteral(""));
        ...
        PushButton_PlayMode->setStyleSheet(QStringLiteral(""));
...
""));
        ...
        PushButton_DeleteMusic->setObjectName(QStringLiteral("PushButton_DeleteMusic"));
        ...
        PushButton_DeleteMusic->setStyleSheet(QStringLiteral(""));
    ...
    {
        AudioPlay->setWindowTitle(QApplication::translate("AudioPlay", "AudioPlay", nullptr));
        logo->setText(QString());
        label_Title->setText(QString());
        commandLinkButton->setText(QApplication::translate("AudioPlay", "\345\270\256\345\212\251", nullptr));
        pushButton_WindowMin->setText(QString());
        pushButton_WindowMax->setText(QString());
        pushButton_WindowExit->setText(QString());
        label_PlayTime->setText(QApplication::translate("AudioPlay", "00:00", nullptr));
        label_MusicTime->setText(QApplication::translate("AudioPlay", "00:00", nullptr));
        ...
        ___qtablewidgetitem->setText(QApplication::translate("AudioPlay", "\346\222\255\346\224\276\345\210\227\350\241\250", nullptr));
